...
@onready var player: Player = get_tree().get_first_node_in_group("Monsters")
...
#States
@export_group("States")
@export var idle_state: MonsterState
@export var walk_state: MonsterState
@export var fall_state: MonsterState
@export var attack_state: MonsterState
#Sprite Variables
var sprite_flipped: bool = false
#Input Keys to test movemeny
var movement_key: String = "Movement"
var left_key: String = "Left"
var right_key: String = "Right"
var jump_key: String = "Jump"
var light_attack_key: String = "LAttack"
var heavy_attack_key: String = "HAttack"
#Input action
